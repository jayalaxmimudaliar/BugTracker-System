...
public class AuthGUI extends JFrame {
    ...
    btnSubmit.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        do {
          ...
          timeout_fail++;
          System.out.println("Attempt " + timeout_fail + " with ID: " + id);
  ...
  public void info() {
    ...
    String link = "<html><body><a href=\"https://github.com/jayalaxmimudaliar\">GitHub Repository</a></body></html>";
    ...
    JScrollPane scrollPane = new JScrollPane(editorPane);  //incase if we add more link
