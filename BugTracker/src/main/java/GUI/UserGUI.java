...
public class UserGUI {
  ...
  public static void projectmanager() {
    ...
    btnMonitor.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {  // display the bug table
  ...
  public static void admin() {
    ...
    btnDelete.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        btnTesters.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.delete("Testers", DeleteFrame);
          }
        });

        btnDevs.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.delete("Developers", DeleteFrame);
          }
        });

        btnPMs.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.delete("Project Managers", DeleteFrame);
          }
        });

        btnAdmins.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.delete("Admins", DeleteFrame);
          }
        });
    ...
    btnUpdate.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        btnTesters.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.Update("Testers", Updateframe);
          }
        });

        btnDevs.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.Update("Developers", Updateframe);
          }
        });

        btnPMs.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.Update("Project Managers", Updateframe);
          }
        });

        btnAdmins.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Admin.Update("Admins", Updateframe);
          }
        });
  ...
  public static void tester(final String email) {
    ...
    btnViewBugs.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        DataBase.viewspecificdata(table, "Bugs", "testerid", ID);  //(JTABLE,table,columnName,specificVAlue)
    ...
    btnAssignBug.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        btnattach.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            JFileChooser fileChooser = new JFileChooser(); //This opens a file chooser window that lets the user browse their computer.
            FileNameExtensionFilter filter = new FileNameExtensionFilter("PNG and JPG Images", "png", "jpg"); 
            fileChooser.setFileFilter(filter);//nly .png and .jpg files will be shown as selectable.



            // Set the file size limit to 5 MB (5 * 1024 * 1024 bytes)
            fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);  //Ensures users can only select files—not folders.
            fileChooser.setAcceptAllFileFilterUsed(false);  //Also disables the "All files" filter to restrict to only your specified formats.
            FileViewWithSizeLimit fsz = new FileViewWithSizeLimit(5 * 1024 * 1024);

            int result = fileChooser.showOpenDialog(assignFrame);  //Waits for user to either select a file or cancel.
            if (result == JFileChooser.APPROVE_OPTION) {
              File selectedFile = fileChooser.getSelectedFile();  //If user clicked "Open", this line fetches the file they picked.


              // Process the selected image file
              System.out.println("Selected file: " + selectedFile.getAbsolutePath());
              path = selectedFile.getAbsolutePath();  //fetches and updates the path
              if (fsz.isTraversable(selectedFile)) { //check file within in 5MB
                textField.setText(path);
              } else {
        ...
        btnSubmit.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            //update deadline 
            //UPDATE Bugs SET deadline = '2025-06-30' WHERE name = 'Crash on login';

            DataBase.updateDatabug("Bugs", "name", BugName, "deadline", formattedDate);
            
            
            
            //update start date i.e current 
            //UPDATE Bugs SET startdate = '2025-06-23' WHERE name = 'Crash on login';
            ...
            //UPDATE Bugs SET developerid = 'D105' WHERE name = 'Crash on login';
